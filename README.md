...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/1.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/2.png)

On créer un nouveau dossier avec 
>mkdir "nom du dossier"

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/3.png)

Pour initialiser Git dans un dossier on utilise la commande :
>git init

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/4.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/5.png)

Après avoir ajouté un fichier il faut effectuer un commit à l'aide de la commande :

> git commit -am "Message du commit"

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/6.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/7.png)

On effectue donc un nouveau commit :

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/8.png)

On peut voir la totalité des commit effectuer avec la commande :
>git log 

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/9.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/10.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/11.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/12.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/13.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/14.png)


On peut voir les fichiers ajoutés sur l'interface graphique du dépôt distant : 

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/15.png)

On peut répéter l’opération pour rajouter des fichiers :


![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/16.png)

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/17.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/18.png)


![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/19.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/20.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/21.png)


 On peut comme sur la branche master ajouter ou modifier des fichiers et faire des commit 

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/22.png)

Ensuite avec la commande push on peut l'envoyer sur le dépôt distant avec à l'aide de la commande :
>git push --set-upstream origin b1


![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/23.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/24.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/25.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/26.png)


Avec le client graphique git GUI on peut observer le graphique des commit :

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/27.png)

On envoie la branche b2 sur le dépôt distant :

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/28.png)

Pour supprimer une branche localement il faut saisir :
>git branch -d "nom de la branche"

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/29.png)

Puis du dépôt distant avec 
>git push --delete origin "nom de la branche"

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/30.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/31.png)

Je clique sur l'onglet pull request.

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/32.png)

Je peux voir le message de la personne demandant le pull request ainsi que les commit qu'il a effectué 

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/33.png)

Pour accepté la pull request j'appuie sur "fusionner la pull request".

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/34.png)


 les modification sont donc maintenant inclus dans mon dépôt.

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/35.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/40.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/41.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/42.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/43.png)

On clone ensuite le dépôt public distant public

>git clone "url dépôt public"

![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/44.png)
...
![git logo](http://10.132.4.51/adrien.chabas/Compte_Rendu_Gogs/raw/master/45.png)
